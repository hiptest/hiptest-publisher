...
# -*- encoding: utf-8 -*-
# stub: hiptest-publisher 0.21.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.email = "contact@hiptest.net".freeze
  ...
  s.homepage = "https://hiptest.net".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.6.7", "~> 1.6.0"])
      ...
      s.add_development_dependency(%q<jeweler>.freeze, [">= 2.1.1", "~> 2.0"])
    else
      ...
      s.add_dependency(%q<nokogiri>.freeze, [">= 1.6.7", "~> 1.6.0"])
      ...
      s.add_dependency(%q<jeweler>.freeze, [">= 2.1.1", "~> 2.0"])
    end
  else
    s.add_dependency(%q<colorize>.freeze, [">= 0.7.5", "~> 0.7"])
    s.add_dependency(%q<parseconfig>.freeze, [">= 1.0.4", "~> 1.0"])
