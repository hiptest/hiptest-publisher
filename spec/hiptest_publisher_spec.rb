...
describe Hiptest::Publisher do
  ...
  context 'sync' do
    before do
      # to use the former endpoint
      stub_request(:post, "https://app.hiptest.com/publication/123456789/async_project").to_return(:status => 404)
    end
    ...
    describe "with invalid arguments" do
      ...
      context "--output-directory" do
        before(:each) {
          # to use the former endpoint
          stub_request(:post, "https://app.hiptest.com/publication/123/async_project").to_return(:status => 404)
  ...
  context 'async' do
    ...
    describe "with invalid arguments" do
      ...
      context "--output-directory" do
        before(:each) {
          stub_request(:post, "https://app.hiptest.com/publication/123/async_project").to_return(:status => 201, :body => { "publication_export_id": 1 }.to_json)
