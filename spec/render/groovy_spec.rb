...
describe 'Render as Groovy' do
  ...
  before(:each) do
    ...
    @scenario_with_datatable_rendered = [
      'def checkLogin(login, password, expected) {',
    ...
    @scenario_with_datatable_rendered_with_uids = [
      ...
      '}',
      '',
      'def "check login - Wrong \'login\' (uid:a-123)"() {',
      '  expect:',
      '  checkLogin("invalid", "invalid", "Invalid username or password")',
      '}',
      '',
      'def "check login - Wrong \"password\" (uid:b-456)"() {',
      '  expect:',
      '  checkLogin("valid", "invalid", "Invalid username or password")',
      '}',
      '',
      'def "check login - Valid \'login\'/\"password\" (uid:c-789)"() {',
      '  expect:',
      '  checkLogin("valid", "valid", null)',
      '}',
      '',
